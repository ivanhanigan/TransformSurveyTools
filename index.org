...
#+begin_src R :session *R* :tangle src/get-data-from-pdf.r :exports none :eval no
  ################################################################
  # name:get-data-from-pdf
...
#+begin_src R :session *R* :tangle src/reminder-of-method-in-logistic-regression.r :exports none :eval no
  ################################################################
  # name:reminder-of-method-in-logistic-regression
...
*** TODO R function to calculate for classification trees
